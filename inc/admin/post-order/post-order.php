...
class PostOrder_Engine {
    ...
    function admin_menu() {
        add_options_page(__('Posts Order', 'order'), __('Posts Order', 'order'), 'manage_options', 'order-settings', array($this, 'admin_page'));
    }

    function admin_page() {
        //require oRDER_DIR . 'settings.php';
    ...
    function update_options() {
        ...
        update_option('order_options', $input_options);
